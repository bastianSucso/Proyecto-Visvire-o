...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {path: 'empresas', loadComponent: () => import('./features/admin/pages/empresas/empresas.page').then(m => m.EmpresasPage),},
      ...
      {path: 'inventario/hoja-compra', loadComponent: () => import('./features/admin/pages/inventario/hoja-compra/inventario-hoja-compra.page').then(m => m.InventarioHojaCompraPage),},
      {path: 'inventario/sala-objetivos', loadComponent: () => import('./features/admin/pages/inventario/sala-objetivos/inventario-sala-objetivos.page').then(m => m.InventarioSalaObjetivosPage),},
      ...
      {path: 'inventario/ajuste-operativo', loadComponent: () => import('./features/admin/pages/inventario/ajuste-operativo/inventario-ajuste-operativo.page').then(m => m.InventarioAjusteOperativoPage),},
      ...
      {path: 'inventario/inconsistencias', loadComponent: () => import('./features/admin/pages/inventario/inconsistencias/inconsistencias-admin.page').then(m => m.InconsistenciasAdminPage),},
      {path: 'inventario/inconsistencias-categorias', loadComponent: () => import('./features/admin/pages/inventario/inconsistencias-categorias/inconsistencias-categorias.page').then(m => m.InconsistenciasCategoriasPage),},
      ...
      {path: 'finanzas/perdidas', loadComponent: () => import('./features/admin/pages/finanzas/perdidas/finanzas-perdidas.page').then(m => m.FinanzasPerdidasPage),},
      {path: 'reporte-ventas', loadComponent: () => import('./features/admin/pages/reporte-ventas/reporte-ventas.page').then(m => m.ReporteVentasPage),},
      {path: 'reporte-ventas/:fecha', loadComponent: () => import('./features/admin/pages/reporte-ventas-detalle/reporte-ventas-detalle.page').then(m => m.ReporteVentasDetallePage),},
