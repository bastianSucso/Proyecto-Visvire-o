...
## Definiciones
- Ventana nocturna: `[20:00, 06:00)`
  - Incluye desde `20:00:00` hasta `05:59:59`.
  - Excluye exactamente `06:00:00`.
- Hora de checkout: `12:00`.

## Algoritmo
1. Tomar `fechaIngreso` en zona `America/Santiago`.
2. Definir `fechaBaseNoche`:
   - Si la hora local de ingreso esta entre `00:00` y antes de `06:00`, usar el dia anterior.
...
- Ingreso `13-02-2026 05:59` -> salida `13-02-2026 12:00`.
- Ingreso `13-02-2026 06:00` -> salida `14-02-2026 12:00`.
